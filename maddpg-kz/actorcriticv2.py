...
class ActorNetwork(object):
	...
	def _build_model(self):
		...
		h = Dense(100,kernel_initializer='glorot_normal')(input_obs)
		h = Activation('relu')(h)
		#h = BatchNormalization()(h)
		h = Dense(20,kernel_initializer='glorot_normal')(h)
		h = Activation('relu')(h)
		#h = BatchNormalization()(h)
		h = Dense(self.action_dim,kernel_initializer='glorot_normal')(h)
		# h = Activation('softmax')(h)
		h = Activation('tanh')(h)
		# to approximate discrete communication decisions with a continuous representation during training
		# pred = Lambda(lambda h: tf.contrib.distributions.RelaxedOneHotCategorical(0.5,probs=h).sample())(h)
		model = Model(inputs=input_obs,outputs=h)
		model.compile(optimizer='Adam',loss='categorical_crossentropy')
		return model,model.trainable_weights,input_obs
	# def _build_model(self):
	# 	input_obs = Input(shape=(self.state_dim,))
	# 	h = Dense(100,trainable=False)(input_obs)
	# 	h = Activation('relu')(h)
	# 	#h = BatchNormalization()(h)
	# 	h = Dense(20,trainable= False)(h)
	# 	h = Activation('relu')(h)
	# 	#h = BatchNormalization()(h)
	# 	h = Dense(self.action_dim,trainable= False)(h)
	# 	# h = Activation('softmax')(h)
	# 	h = Activation('tanh')(h)
	# 	# to approximate discrete communication decisions with a continuous representation during training
	# 	# pred = Lambda(lambda h: tf.contrib.distributions.RelaxedOneHotCategorical(0.5,probs=h).sample())(h)
...
class CriticNetwork(object):
	...
	def _build_model(self):
		...
		h = Activation('relu')(h)
		#h = BatchNormalization()(h)
		action_abs = Dense(100,kernel_initializer='glorot_normal')(input_actions)
		temp1 = Dense(100,kernel_initializer='glorot_normal')(h)
		...
		h = Activation('relu')(h)
		#h = BatchNormalization()(h)
		pred = Dense(1,kernel_initializer='glorot_normal')(h)
	...
	# 	h = Activation('relu')(h)
	# 	#h = BatchNormalization()(h)
	# 	action_abs = Dense(100,trainable= False)(input_actions)
	# 	temp1 = Dense(100,trainable= False)(h)
	# 	#action_abs = Activation('relu')(action_abs)
	# 	#action_abs = BatchNormalization()(action_abs)
	# 	h = Add()([temp1,action_abs])
	# 	#h = Dense(64)(h)
	# 	h = Activation('relu')(h)
	# 	#h = BatchNormalization()(h)
	# 	pred = Dense(1,trainable= False)(h)
	# 	model = Model(inputs=[input_obs,input_actions],outputs=pred)
	# 	model.compile(optimizer='Adam',loss='mean_squared_error')
	# 	return model,input_obs,input_actions
